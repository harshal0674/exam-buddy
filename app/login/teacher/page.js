...
export default function TeacherLoginPage() {
  ...
  return (
    <div style={{
      ...
      background: "radial-gradient(ellipse at 60% 0%, rgba(41,151,255,0.12) 0%, #000 60%)",
      padding: "2rem",
    }}>
      <div style={{
        width: "100%",
        ...
        <div style={{
          ...
          <div style={{ textAlign: "center" }}>
            ...
            <p style={{ color: "#86868b", fontSize: "0.9rem", marginTop: "0.5rem", lineHeight: 1.5 }}>
              Upload materials, manage PDFs, and help students prepare for exams.
            </p>
          </div>
        ...
        <p style={{ color: "#86868b", fontSize: "0.875rem" }}>
          Are you a student?{" "}
          <Link href="/login/student" style={{ color: "#2997ff", fontWeight: "500" }}>
            Sign in here
          </Link>
        </p>
      </div>
